...
public:
    ...
    void setupUi(QWidget *Editor)
    {
        ...
        anatomy_edit_page->setObjectName("anatomy_edit_page");
        ...
        editor_graphicsView->setObjectName("editor_graphicsView");
        ...
        cells_group->setObjectName("cells_group");
        cells_group->addButton(rb_mouth);
        rb_mouth->setObjectName("rb_mouth");
        ...
        cmb_block_rotation->addItem(QString());
        cmb_block_rotation->addItem(QString());
        cmb_block_rotation->setObjectName("cmb_block_rotation");
        ...
        label_cell_count->setObjectName("label_cell_count");

        verticalLayout_5->addWidget(label_cell_count);

        label_occ_count = new QLabel(anatomy_edit_page);
        label_occ_count->setObjectName("label_occ_count");
        ...
        le_move_range->setObjectName("le_move_range");
        ...
        le_anatomy_mutation_rate->setObjectName("le_anatomy_mutation_rate");
        ...
        le_brain_mutation_rate->setObjectName("le_brain_mutation_rate");
        ...
        cmb_organism_rotation->addItem(QString());
        cmb_organism_rotation->addItem(QString());
        cmb_organism_rotation->setObjectName("cmb_organism_rotation");
        ...
        b_reset_editing_view->setObjectName("b_reset_editing_view");

        verticalLayout_5->addWidget(b_reset_editing_view);

        b_reset_organism = new QPushButton(anatomy_edit_page);
        b_reset_organism->setObjectName("b_reset_organism");
        ...
        b_resize_editing_grid->setObjectName("b_resize_editing_grid");
        ...
        brain_edit_page->setObjectName("brain_edit_page");
        ...
        brain_vertical_layout->setObjectName("brain_vertical_layout");
        ...
        te_occ_edit_window->setObjectName("te_occ_edit_window");
        ...
        b_tcompile_occ->setObjectName("b_tcompile_occ");

        horizontalLayout_16->addWidget(b_tcompile_occ);

        cb_short_instructions = new QCheckBox(page_2);
        cb_short_instructions->setObjectName("cb_short_instructions");
        ...
        organism_action_group->setObjectName("organism_action_group");
        organism_action_group->addButton(rb_place_organism);
        rb_place_organism->setObjectName("rb_place_organism");
        ...
        rb_chose_organism->setObjectName("rb_chose_organism");
        ...
        b_save_organism->setObjectName("b_save_organism");

        horizontalLayout_6->addWidget(b_save_organism);

        b_load_organism = new QPushButton(widget);
        b_load_organism->setObjectName("b_load_organism");
        ...
        rb_edit_anatomy->setObjectName("rb_edit_anatomy");
    ...
    {
        Editor->setWindowTitle(QCoreApplication::translate("Editor", "Organism Editor", nullptr));
        rb_mouth->setText(QCoreApplication::translate("Editor", "Mouth", nullptr));
        rb_producer->setText(QCoreApplication::translate("Editor", "Producer", nullptr));
        rb_mover->setText(QCoreApplication::translate("Editor", "Mover", nullptr));
        rb_killer->setText(QCoreApplication::translate("Editor", "Killer", nullptr));
        rb_armor->setText(QCoreApplication::translate("Editor", "Armor", nullptr));
        rb_eye->setText(QCoreApplication::translate("Editor", "Eye", nullptr));
        label_7->setText(QCoreApplication::translate("Editor", "Block Rotation:", nullptr));
        cmb_block_rotation->setItemText(0, QCoreApplication::translate("Editor", "Up", nullptr));
        cmb_block_rotation->setItemText(1, QCoreApplication::translate("Editor", "Left", nullptr));
        cmb_block_rotation->setItemText(2, QCoreApplication::translate("Editor", "Down", nullptr));
        cmb_block_rotation->setItemText(3, QCoreApplication::translate("Editor", "Right", nullptr));

        label_cell_count->setText(QCoreApplication::translate("Editor", "Cell count:", nullptr));
        label_occ_count->setText(QCoreApplication::translate("Editor", "OCC instruction count:", nullptr));
        label_2->setText(QCoreApplication::translate("Editor", "Move range:", nullptr));
        label_3->setText(QCoreApplication::translate("Editor", "Anatomy mutation rate:", nullptr));
        label_6->setText(QCoreApplication::translate("Editor", "Brain mutation rate:", nullptr));
        label_8->setText(QCoreApplication::translate("Editor", "Starting organism rotation:", nullptr));
        cmb_organism_rotation->setItemText(0, QCoreApplication::translate("Editor", "Up", nullptr));
        cmb_organism_rotation->setItemText(1, QCoreApplication::translate("Editor", "Left", nullptr));
        cmb_organism_rotation->setItemText(2, QCoreApplication::translate("Editor", "Down", nullptr));
        cmb_organism_rotation->setItemText(3, QCoreApplication::translate("Editor", "Right", nullptr));

        b_reset_editing_view->setText(QCoreApplication::translate("Editor", "Reset View", nullptr));
        b_reset_organism->setText(QCoreApplication::translate("Editor", "Reset organism", nullptr));
        label_4->setText(QCoreApplication::translate("Editor", "Grid width:", nullptr));
        label_5->setText(QCoreApplication::translate("Editor", "Grid height:", nullptr));
        b_resize_editing_grid->setText(QCoreApplication::translate("Editor", "Resize editing grid", nullptr));
        b_tcompile_occ->setText(QCoreApplication::translate("Editor", " Compile code", nullptr));
        cb_short_instructions->setText(QCoreApplication::translate("Editor", "Short instructions", nullptr));
        rb_place_organism->setText(QCoreApplication::translate("Editor", "Place Organism", nullptr));
        rb_chose_organism->setText(QCoreApplication::translate("Editor", "Choose organism", nullptr));
        rb_null_button->setText(QString());
        b_save_organism->setText(QCoreApplication::translate("Editor", "Save Organism", nullptr));
        b_load_organism->setText(QCoreApplication::translate("Editor", "Load Organism", nullptr));
        rb_edit_anatomy->setText(QCoreApplication::translate("Editor", "Edit Anatomy", nullptr));
        rb_edit_brain->setText(QCoreApplication::translate("Editor", "Edit brain", nullptr));
        rb_edit_occ->setText(QCoreApplication::translate("Editor", "Edit OCC", nullptr));
    } // retranslateUi
