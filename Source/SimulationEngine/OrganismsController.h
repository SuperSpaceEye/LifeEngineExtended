...
public:
    ...
    static Organism *get_organism_by_index(int32_t organism_index, EngineDataContainer &edc);
    static Organism *get_child_organism_by_index(int32_t child_organism_index, EngineDataContainer &edc);
};
