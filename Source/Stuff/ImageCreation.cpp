...
color ImageCreation::ImageCreationTools::get_texture_color(BlockTypes type, Rotation rotation,
...
color ImageCreation::ImageCreationTools::get_kernel_texture_color(BlockTypes type,
                                                                  Rotation rotation,
                                                                  int texture_x,
                                                                  int texture_y,
                                                                  int texture_width,
    ...
    std::vector<std::pair<color, int>> used_colors;
    ...
    for (int _x = texture_x * kernel_size; _x < texture_x * kernel_size + kernel_size; _x++) {
        for (int _y = texture_y * kernel_size; _y < texture_y * kernel_size + kernel_size; _y++) {
            ...
            if (!is_in) {used_colors.emplace_back(std::pair<color, int>{_color, 1});}
        }
    }
